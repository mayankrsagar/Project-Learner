  ...
  return (
    ...
    >
      <form
        ...
        onClick={(e) => e.stopPropagation()} // prevent overlay click when interacting with form
        className="relative bg-white dark:bg-neutral-800 rounded-xl p-6 w-full max-w-2xl space-y-4 shadow-lg"
      >
        {/* Close (X) button */}
        <button
          type="button"
          ...
          aria-label="Close"
          title="Close"
          className="absolute right-4 top-4 rounded p-1 hover:bg-gray-100 dark:hover:bg-neutral-700"
        >
          <svg
