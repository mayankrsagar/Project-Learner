...
import { EducationItem, SocialData, UserProfile } from "@/types";
...
const KeyValue: React.FC<{ label: string; value: string; date?: string }> = ({
  label,
  value,
  date,
}) => (
    ...
    <ProtectedRoute>
      <div className="space-y-8 p-4 max-w-4xl mx-auto">
        ...
        <SectionCard
          ...
          onEdit={() => setProfOpen(true)}
        >
          <KeyValue
            label="Profession"
            value={userData.currentProfession ?? ""}
          />
          <KeyValue
            label="Preferred Location"
            value={userData.preferredJobLocation ?? ""}
          />
        </SectionCard>
